...
from ..utils.import_utils import is_torch_available, is_torchdynamo_compiling, is_torch_npu_available
...
def npu_grouped_mm_experts_sparse_block_forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
...
class ExpertsInterface(GeneralInterface):
    ...
    _global_mapping = {
        ...
        "npu_grouped_mm": npu_grouped_mm_experts_forward,
        "npu_grouped_mm_sparse_block": npu_grouped_mm_experts_sparse_block_forward, 
    }
